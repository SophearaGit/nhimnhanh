                    ...
                    <div id="gallery-masonary" class="gallery-items colums-3">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/1.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/2.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/3.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/6.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/5.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
                        ...
                        <div class="gallery-item">
                            <div class="gallery-style-one">
                                <img src="{{ asset('frontend/assets/img/projects/4.jpg') }}" alt="Thumb">
                                <div class="info">
                                    <div class="overlay">
                                        <div class="content">
                                            <ul class="pf-tags">
