                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-style-one">
                                    <div class="item">
                                        <div class="thumb">
                                            <div class="inner">
                                                <img src="{{ asset('frontend/assets/img/illustration/2.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                        </div>
                                        <div class="content">
                                            <div class="tm-review">
                                                ...
                                                <div class="bottom">
                                                    <img src="{{ asset('frontend/assets/img/partner/9.png') }}"
                                                        alt="Image Not Found">
                                                    <p>4.9/ 60 Reviews</p>
                                                </div>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-style-one">
                                    <div class="item">
                                        <div class="thumb">
                                            <div class="inner">
                                                <img src="{{ asset('frontend/assets/img/illustration/3.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                        </div>
                                        <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-style-one">
                                    <div class="item">
                                        <div class="thumb">
                                            <div class="inner">
                                                <img src="{{ asset('frontend/assets/img/illustration/4.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                        </div>
                                        <div class="content">
